...
{
    public class NowaDefinicjaPlatnosciViewModel : JedenViewModel<DefinicjaPlatnosci> //wszystkie zakladni dziedzicza po WorkSpaceViewModel
    {
        #region Konstruktor
        public NowaDefinicjaPlatnosciViewModel()
            : base("Definicja platnosci")
        {
            item = new DefinicjaPlatnosci();
