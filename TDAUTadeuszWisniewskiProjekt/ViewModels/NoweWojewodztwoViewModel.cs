...
{
    public class NoweWojewodztwoViewModel : JedenViewModel<Wojewodztwo> //wszystkie zakladni dziedzicza po WorkSpaceViewModel
    {
        #region Konstruktor
        public NoweWojewodztwoViewModel()
           : base("Wojewodztwo")
        {
            item = new Wojewodztwo();
