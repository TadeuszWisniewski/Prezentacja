...
{
    public class NowaFormaPrawnaViewModel : JedenViewModel<FormaPrawna> //wszystkie zakladni dziedzicza po WorkSpaceViewModel
    {
        #region Konstruktor
        public NowaFormaPrawnaViewModel()
            : base("Forma prawna")
        {
            item = new FormaPrawna();
