...
{
    public class NowyMiejscowoscViewModel : JedenViewModel<Miejscowosc> //wszystkie zakladni dziedzicza po WorkSpaceViewModel
    {
        #region Konstruktor
        public NowyMiejscowoscViewModel()
            : base("Miejscowosc")
        {
            item = new Miejscowosc();
